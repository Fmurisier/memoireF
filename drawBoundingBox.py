...
def drawBoundingBox(selection="(all)", padding=0.0, linewidth=2.0, r=1.0, g=1.0, b=1.0):
    ...
    fichier = open('/home/fred/Documents/work/SRSF2/modelisation/boxpymol.txt', 'w')
    fichier.write('test')
    fichier.write("Box dimensions (%.2f, %.2f, %.2f)" % (maxX - minX, maxY - minY, maxZ - minZ))
    ...
    if padding != 0:
        print
        "Box dimensions + padding (%.2f, %.2f, %.2f)" % (maxX - minX, maxY - minY, maxZ - minZ)
